  ...
  packages = [
    ...
    }
    {
      ...
      path = fetchurl {
        ...
        sha512 = "fOYjrxQv8zJsqOY6V6ecP4eZhQBxtY80X0er1VVnUIAIZo74jHm8e1vguG5Yt4Iv8W2Wr7TgibB8MfRe32k9pA==";
      };
    }
    {
    ...
    {
      name = "vscode_json_languageservice___vscode_json_languageservice_4.1.8.tgz";
      path = fetchurl {
        name = "vscode_json_languageservice___vscode_json_languageservice_4.1.8.tgz";
        url  = "https://registry.yarnpkg.com/vscode-json-languageservice/-/vscode-json-languageservice-4.1.8.tgz";
    ...
    {
      name = "yaml___yaml_2.0.0_10.tgz";
      path = fetchurl {
        name = "yaml___yaml_2.0.0_10.tgz";
        url  = "https://registry.yarnpkg.com/yaml/-/yaml-2.0.0-10.tgz";
